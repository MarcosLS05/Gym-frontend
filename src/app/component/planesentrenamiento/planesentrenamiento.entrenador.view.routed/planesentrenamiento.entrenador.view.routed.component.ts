...
@Component({
  selector: 'app-planesentrenamiento.entrenador.view.routed',
  templateUrl: './planesentrenamiento.entrenador.view.routed.component.html',
  styleUrls: ['./planesentrenamiento.entrenador.view.routed.component.css'],
})
export class PlanesentrenamientoEntrenadorViewRoutedComponent implements OnInit {
  id: number = 0;
  route: string = '';
  titulo: string = '';
